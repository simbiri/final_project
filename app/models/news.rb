...
class News < ApplicationRecord
  ...
  belongs_to :user, class_name: "User", foreign_key: "journalist_id", required: true
  
  # This association links the news item to another user who is featured in the news. 
  # The 'class_name' is "User", and 'foreign_key' is "featuring_user_id".
  belongs_to :featured_user, class_name: "User", foreign_key: "featuring_user_id"
