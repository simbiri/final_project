class FollowRequestsController < ApplicationController
  ...
  def create
    ...
    the_follow_request.sent_follow_request = params.fetch("query_sent_follow_request")
    the_follow_request.received_follow_request = params.fetch("query_received_follow_request")
    the_follow_request.request_status = params.fetch("query_request_status")
